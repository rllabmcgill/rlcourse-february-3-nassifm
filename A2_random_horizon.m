function values = A2_random_horizon(gamma, weighted, time, fixed_init)
% A2_RANDOM_HORIZON Calculates values using random horizon method
%   Uses every-visit methodology.
%   gamma (real [0,1]): discount factor (probability of survival)
